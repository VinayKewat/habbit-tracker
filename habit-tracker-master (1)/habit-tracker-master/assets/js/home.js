...
// if u click on add then this btn will u dailogbox
...
// if u make habbit done then this time this function will perform
...
// if u dont add anything then it show not done 
...
// if u click on yes then it show u done 
...
// if u dont do our task then it give you pending option
else{
days[i].innerText="";
